          ...
          <Card>
            <CardContent className="p-4">
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className={`text-sm w-full text-left px-2 py-1 rounded ${
                      !filters.category ? 'bg-primary/10 text-primary' : 'text-muted-foreground hover:bg-accent'
                    }`}
                  >
                    All Categories
                  </button>
                  {categories.map((category) => (
                    <button
                      ...
                      className={`text-sm w-full text-left px-2 py-1 rounded ${
                        filters.category === category ? 'bg-primary/10 text-primary' : 'text-muted-foreground hover:bg-accent'
                      }`}
                    >
                      {category}
                    </button>
              ...
              <div className="space-y-3 mt-6">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) => setFilters({ ...filters, minPrice: Number(e.target.value) || undefined, page: 1 })}
                    className="w-full"
                  />
                  <Input
                    type="number"
                    ...
                    onChange={(e) => setFilters({ ...filters, maxPrice: Number(e.target.value) || undefined, page: 1 })}
                    className="w-full"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3 mt-6">
                ...
                <select
                  value={filters.sort || ''}
                  onChange={(e) => setFilters({ ...filters, sort: e.target.value as ProductFilters['sort'], page: 1 })}
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <Button
                          ...
                          disabled={product.stock === 0 || (isAddingToCart && addingProductId === product._id)}
                        >
