...
import { Button, Card, CardContent, CardHeader, CardTitle, Input, Label, Skeleton, Badge } from '@/components/ui';
import { useSellerProducts, useCreateProduct, useUpdateProduct, useDeleteProduct } from '@/hooks';
